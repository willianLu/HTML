...
(function() {
  var link = (function(domGlobals) {
    ...
    var unlink = function(editor) {
      editor.undoManager.transact(function() {
        ...
        if (isImageFigure(node)) {
          ...
          var anchorElm = editor.dom.getParent(
            node,
            "a[href]",
            editor.getBody()
          );
    ...
    var extractFromAnchor = function(editor, settings, anchor, selection) {
      ...
      var text = onlyText
        ? Option.some(Utils.getAnchorText(selection, anchor))
        : Option.none();
      var url = anchor
    ...
    var handleSubmit = function(editor, info, assumeExternalTargets) {
      return function(api) {
        ...
        DialogConfirms.preprocess(
          ...
          console.log(editor, attachState, pData,'------link');
    ...
    var makeDialog = function(settings, onSubmit, editorSettings) {
      ...
      var titleText = settings.flags.titleEnabled
        ...
        : [];
      var defaultTarget = Settings.hasDefaultLinkTarget(editorSettings)
        ? Option.some(Settings.getDefaultLinkTarget(editorSettings))
        : Option.none();
